...
$MESS ['RUNDESIGNER_MESSAGE_ADD'] = "+ Добавить комментарий";
$MESS ['RUNDESIGNER_MESSAGE_IMYA'] = "Имя";
$MESS ['RUNDESIGNER_MESSAGE_EMAIL'] = "Емайл";
$MESS ['RUNDESIGNER_MESSAGE_SEND'] = "Отправить";
$MESS ['RUNDESIGNER_MESSAGE_WRONGFORM'] = "Есть ошибки при заполнении формы! Комментарий не отправлен.";
